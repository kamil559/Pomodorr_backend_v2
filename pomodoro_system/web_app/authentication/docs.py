        ...
        'operations': {
            'post': {
                ...
                'responses': {
                    ...
                    '400': {
                        'description': 'Either email or password is not valid (Validation error).'
                    }
                },
                'tags': [
                    'auth'
    ...
    'logout': {
        ...
        'operations': {
            'get': {
                ...
                'responses': {
                    '302': {
                        'description': 'The user has been logged out and redirected to /.'
                    },
                    '404': {
                        'description': 'The redirect page does not exist.'
                    }
                },
                'tags': [
                    'auth'
    ...
    'register': {
        ...
        'operations': {
            'post': {
                ...
                'responses': {
                    '200': {
                        'description': 'User has been registered and a confirmation email has been sent.'
                    },
                    '400': {
                        'description': 'Either email or password is not valid (Validation error).'
                    }
    ...
    'confirm': {
        ...
        'operations': {
            'get': {
                ...
                'responses': {
                    '302': {
                        'description': 'The registration has been confirmed and the user will be redirected to /.'
                    },
                    '400': {
                        'description': 'The token might have expired or is invalid.'
                    },
                    '404': {
                        'description': 'The redirect page does not exist.'
                    }
        ...
        'operations': {
            'post': {
                ...
                'responses': {
                    ...
                    '400': {
                        'description': 'The entered email does not correspond to any user.'
                    }
                },
                'tags': [
                    'auth'
    ...
    'set_new_password': {
        ...
        'operations': {
            'post': {
                ...
                'responses': {
                    '200': {
                        'description': 'The entered password has been set.'
                    },
                    '400': {
                        'description': 'Either the passwords don\'t match or did not pass the validation process.'
                    }
                },
                'tags': [
                    'auth'
