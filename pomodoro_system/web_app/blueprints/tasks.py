...
from pomodoros import TaskId, CompleteTask, CompleteTaskOutputBoundary, ReactivateTask, ReactivateTaskOutputBoundary, \
    PinTaskToProject, PinTaskToProjectOutputBoundary, PinTaskToProjectInputDto, ReactivateTaskInputDto, \
...
def complete_task(task_id: TaskId, complete_task_uc: CompleteTask, presenter: CompleteTaskOutputBoundary,
    ...
    input_dto: CompleteTaskInputDto = get_dto_or_abort(CompleteTaskSchema,
...
@jwt_required
def pin_task_to_project(task_id: TaskId, pin_task_to_project_uc: PinTaskToProject,
                        presenter: PinTaskToProjectOutputBoundary, task_protector: TaskProtector,
                        project_protector: ProjectProtector) -> Response:
