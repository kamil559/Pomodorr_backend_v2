...
class TestBeginPomodoroAPI:
    ...
    def test_begin_pomodoro_with_random_authenticated_user(self, client: testing.FlaskClient, orm_task,
...
class TestPausePomodoroAPI:
    ...
    def test_pause_pomodoro_with_random_authenticated_user(self, client: testing.FlaskClient, started_orm_pomodoro,
                                                           random_project_owner_authorization_token):
        response = client.post(f'/pomodoros/{started_orm_pomodoro.id}/pause',
                               headers={'Authorization': random_project_owner_authorization_token}, json={})
...
class TestResumePomodoroAPI:
    ...
    def test_resume_pomodoro_with_random_authenticated_user(self, client: testing.FlaskClient, paused_orm_pomodoro,
                                                            random_project_owner_authorization_token):
        response = client.post(f'/pomodoros/{paused_orm_pomodoro.id}/resume',
                               headers={'Authorization': random_project_owner_authorization_token}, json={})
...
class TestFinishPomodoroAPI:
    ...
    def test_finish_pomodoro_with_random_authenticated_user(self, client: testing.FlaskClient, started_orm_pomodoro,
                                                            random_project_owner_authorization_token):
        response = client.patch(f'/pomodoros/{started_orm_pomodoro.id}/finish',
                                headers={'Authorization': random_project_owner_authorization_token}, json={})
