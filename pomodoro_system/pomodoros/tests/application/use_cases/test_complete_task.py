...
def test_complete_task_use_case_with_one_time_task(one_time_task, complete_task_output_boundary,
    ...
    expected_output_dto = CompleteTaskOutputDto(id=one_time_task.id, status=TaskStatus.COMPLETED,
                                                new_task_id=None)
...
def test_complete_task_use_case_with_repeatable_task(task, complete_task_output_boundary, complete_task_use_case,
    ...
    expected_output_dto = CompleteTaskOutputDto(id=task.id, status=TaskStatus.COMPLETED,
                                                new_task_id=next_due_date_task.id)
